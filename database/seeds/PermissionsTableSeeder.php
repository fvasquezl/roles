...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            ...
            'description' => 'Listar y navegar todos las categorias del sistema',
        ]);
        Permission::create([
        ...
        Permission::create([
            ...
            'description' => 'Crear una categoria dentro del sistema',
        ]);
        Permission::create([
        ...
        Permission::create([
            ...
            'description' => 'Eliminar categorias del sistema',
        ]);
